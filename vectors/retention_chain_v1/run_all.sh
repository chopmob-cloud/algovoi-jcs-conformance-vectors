...
run "Elixir (jcs 0.2.0, pzingg/jcs)"                  elixir runner_elixir.exs retention_chain_v1.json
run "Kotlin/JVM (java-json-canonicalization 1.1)"     bash -c 'cd runner_kotlin && java -cp "runner.jar;libs/*" RunnerKt ../retention_chain_v1.json'
