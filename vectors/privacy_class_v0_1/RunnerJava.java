// RunnerJava.java — cyberphone/json-canonicalization runner for x402 privacy_class attestation v0.
//
...
// This file adds only:
//   - a minimal JSON extractor to locate vector framing fields (attestation_body,
//     expected_privacy_class_hash, expectation, vector_id) within privacy_class_v0.json
...
//         RunnerJava.java
//   java -cp classes RunnerJava privacy_class_v0.json
...
public class RunnerJava {
    ...
    // ONLY used to slice privacy_class_v0.json into per-vector chunks; canonicalization
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 1) {
            System.err.println("usage: RunnerJava privacy_class_v0.json");
            System.exit(2);
        }
        ...
        for (int[] r : ranges) {
            ...
            String body = extractField(vec, "attestation_body");
            String expectedSha = extractField(vec, "expected_privacy_class_hash");
