// epi_interop_v0 runner -- Java 17 / cyberphone/java-json-canonicalization 1.1
//
// Validates sha256(JCS(input)) == frame_id for each vector
//
// Build & run (from epi_interop_v0/runner_java/):
//   javac -cp "libs/*" Runner.java
//   java -cp ".;libs/*" Runner          (Windows)
//   java -cp ".:libs/*" Runner          (Unix)
...
public class Runner {
    ...
    public static void main(String[] args) throws Exception {
        String path = args.length > 0 ? args[0] : "epi_interop_v0.json";
